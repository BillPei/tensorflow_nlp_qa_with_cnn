...
##########################################################################
# random init embedded layer + cnn + cosine margine ,  batch
# option to use static embedded layer by loading pretrained word2vec model
# alert for memory issue
##########################################################################

class ECQACNN(object):
    def __init__(
      ...
      filter_sizes, num_filters, l2_reg_lambda=0.0):
        ...
        for i, filter_size in enumerate(filter_sizes):
            with tf.name_scope("conv-maxpool-%s" % filter_size):
                ...
                #question, answer, rand_answer with own conv layer
                #represent and match sentences simultaneously 
                conv = tf.nn.conv2d(
        ...
        #dropout for regularization: keep prob =1 for this model
        ...
        #vector length for question and answer
        ...
        #dot product between question and answer
        ...
        with tf.name_scope("output"):
            self.cos_12 = tf.div(pooled_mul_12, tf.mul(pooled_len_1, pooled_len_2), name="scores") 
